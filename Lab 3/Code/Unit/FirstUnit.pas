...
// Declaring methods
// initArray - initialization of array. Void
// doSumOrSubOfMatrix - calculates sum or sub of matrix
// according to flag. Returns matrix
// doMultiply - multiplies matrixes. Return matrix
// doMultiplyNum - multiplies matrix with num. Returns matrix
// doPrintMatrix - print matrix. Void
var
  A: TMatrix;
  B: TMatrix;
  resultOf: Integer;
